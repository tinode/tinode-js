...
AGENT:BEGIN:VCARD
 ...
 N:Doe;John;Q.,Public
 FN:John Doe
 TEL;TYPE=WORK,VOICE:(111) 555-3333
 TEL;TYPE=HOME,VOICE:(404) 555-4444
 TEL;TYPE=HOME,TYPE=VOICE:(404) 555-5555
 EMAIL;TYPE=PREF,INTERNET:forrest-gump-agent@example.com
 EMAIL;TYPE=INTERNET:example-agent@example.com
 PHOTO;VALUE=URL;TYPE=PNG:http://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Example_svg.svg/200px-Example_svg.svg.png
 END:VCARD
END:VCARD`;
