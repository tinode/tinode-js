...
Drafty.insertImage = function(content, at, imageDesc) {
  ...
  if (imageDesc.urlPromise) {
    ...
    imageDesc.urlPromise.then(
      (url) => {
        // FIXME: commented out for debugging only.
        // ex.data.ref = url;
