...
Topic.prototype = {
  ...
  note: function(what, seq) {
    ...
    if (user) {
      ...
      // Self-subscription is not found, such as in case of no S permission or channel.
