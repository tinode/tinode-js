...
const DECORATORS = {
  ...
  IM: {
    ...
    props: function(data) {
      if (!data) return null;
      let url = data.ref || base64toObjectUrl(data.val, data.mime);
      return {
        src: url,
        title: data.name,
