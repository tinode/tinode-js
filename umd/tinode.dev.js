  ...
  publishDraft: function(pub, prom) {
    ...
    prom = (prom || Promise.resolve()).then(
      ( /* argument ignored */ ) => {
        ...
        console.log("Upload promise resolved OK");
        return this.publishMessage(pub);
      },
      (err) => {
        console.log("Message draft failed", err);
