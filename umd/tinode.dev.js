...
Topic.prototype = {
  ...
  leave: function(unsub) {
    console.log("leave", unsub, this.name);
  ...
  _gone: function() {
    ...
    console.log("topic._gone", this.name);
